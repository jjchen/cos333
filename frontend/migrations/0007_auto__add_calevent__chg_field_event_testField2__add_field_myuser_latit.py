...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyUser.latitude'


        # Adding field 'MyUser.longitude'
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.testField2'
        db.alter_column(u'frontend_event', 'testField2', self.gf('django.db.models.fields.CharField')(max_length=40))
        # Deleting field 'MyUser.latitude'
        db.delete_column(u'frontend_myuser', 'latitude')

        # Deleting field 'MyUser.longitude'
        db.delete_column(u'frontend_myuser', 'longitude')
